...
To use these stylesheets, rename the files and omegadbm with the name of your theme.
...
omegadbm-alpha-default-narrow.css  
...
omegadbm-alpha-default-normal.css
...
omegadbm-alpha-default-wide.css
